          ...
          <div className="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
            {page.props.auth.user ? (
              <Link
                ...
                className="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:rounded-sm focus:outline-red-500"
              >
                Dashboard
              </Link>
            ) : (
              <>
                ...
                {canRegister ? (
                  <Link
                    href={route('register')}
                    className="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:rounded-sm focus:outline-red-500"
                  >
                    Register
                  </Link>
                ) : null}
                ...
                <div>
                  ...
                  <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                    ...
                    <a
                      ...
                      className="underline hover:text-gray-700 dark:hover:text-white focus:outline focus:rounded-sm focus:outline-red-500"
                    >
                      Forge
                    </a>
                    ,{' '}
            ...
            <div className="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-left">
              <div className="flex items-center gap-4">
                <a
                  ...
                  className="group inline-flex items-center hover:text-gray-700 dark:hover:text-white focus:outline focus:rounded-sm focus:outline-red-500"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
